...
public enum ProcessRunner {
    public static func run(_ executable: String, _ args: [String], env: [String: String] = [:], timeout: TimeInterval? = nil) async throws -> ProcessResult {
        try await withCheckedThrowingContinuation { continuation in
            ...
            fullEnv["PATH"] = "/opt/homebrew/bin:/usr/local/bin:" + (fullEnv["PATH"] ?? "/usr/bin:/bin:/usr/sbin:/sbin")
            ...
            do {
                ...
                continuation.resume(throwing: ProcessRunnerError.launchFailed("Nie mozna uruchomic \(executable): \(error.localizedDescription)"))
                return
            }
    ...
    public static func runRclone(_ args: [String], timeout: TimeInterval? = nil) async throws -> ProcessResult {
    ...
    public static func runTmutilUnattended(_ args: [String], timeout: TimeInterval? = nil) async throws -> ProcessResult {
