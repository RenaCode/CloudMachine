...
public enum Loc {
  ...
  private static let translations: [String: [String: String]] = [
    "en": [
      ...
      "Ten kreator pomoże Ci skonfigurować połączenie z Google Drive przy użyciu Rclone, zainstalować demona montującego i ustawić pierwszą maszynę.":
        "This wizard will help you set up connection to Google Drive using Rclone, install the mount daemon, and set up your first machine.",
      ...
      "GB. Zmniejsz limity lub zwiększ rozmiar dysku w Ustawieniach.":
        "GB. Decrease limits or increase drive size in Settings.",
