...
public enum CMPaths {
    ...
    public static var mountDesiredStatePath: URL { appSupportDir.appendingPathComponent("mount-desired.state") }
    ...
    public static var agentBinaryPath: URL? {
        ...
        if let bundled = Bundle.main.executableURL?.deletingLastPathComponent().appendingPathComponent("cloudmachine-agent"),
