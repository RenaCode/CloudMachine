...
public enum CMLogger {
    ...
    @discardableResult
    public static func rotateIfLarge(_ url: URL, maxBytes: Int = 200 * 1024 * 1024, keepLines: Int = 5000) -> Bool {
        ...
        do {
            ...
            log("Przycieto \(url.lastPathComponent) (bylo \(size) bajtow, zachowano ostatnie \(keepLines) linii).")
            return true
        } catch {
            return false
        }
