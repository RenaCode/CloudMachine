...
struct MountWatchdog: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "mount-watchdog",
    abstract: "Sprawdza zdrowie montowania i naprawia je automatycznie, jesli zawieszone.")
...
struct BackupWatchdog: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "backup-watchdog",
    abstract:
      "Wznawia backup Time Machine, jesli jest bezczynny mimo ze CloudMachine powinno byc aktywne.")
...
struct QuotaWatchdog: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    commandName: "quota-watchdog",
    abstract: "Przycina najstarsze backupy, jesli przekroczony limit miejsca tej maszyny.")
